...
class _ApiService implements ApiService {
  ...
  Future<ServiceResponseModel> getServices() async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ServiceResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ServiceResponseModel.fromJson(_result.data!);
    return value;
  }

  @override
  Future<ServiceResponseModel> getPopularServices() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<CountriesResponseModel> getCountries(int pageNumber) async {
    const _extra = <String, dynamic>{};
