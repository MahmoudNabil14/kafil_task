...
class TextStyles {
  static TextStyle font18BlackW600 = TextStyle(fontSize: 18.sp, fontWeight: FontWeight.w600, color: ColorsManager.black);
  static TextStyle font12GrayW500 = TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w500, color: ColorsManager.gray);
  static TextStyle font13BlackW500 = TextStyle(fontSize: 13.sp, fontWeight: FontWeight.w500, color: ColorsManager.black);
  static TextStyle font13mediumGrayW400 = TextStyle(fontSize: 13.sp, fontWeight: FontWeight.w400, color: ColorsManager.mediumGray);
  static TextStyle font13lighterGoldW400 = TextStyle(fontSize: 13.sp, fontWeight: FontWeight.w400, color: ColorsManager.lighterGold);
  static TextStyle font12lighterGrayW500 = TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w500, color: ColorsManager.lighterGray);
